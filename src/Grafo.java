...
public class Grafo {
    ...
    public void adicionaConexao(int user1_id, int user2_id) {
        matrizAdjacencia[user1_id][user2_id] = 1;
        matrizAdjacencia[user2_id][user1_id] = 1;
        System.out.println("Conexao entre usuarios de IDs " +user1_id+ " e " +user2_id+ " foi efetuada com sucesso!");
    }
